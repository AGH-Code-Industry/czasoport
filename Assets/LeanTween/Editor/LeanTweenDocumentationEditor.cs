...
public class LeanTweenDocumentationEditor : Editor {
    ...
    static void openDocumentation() {
        ...
        string browserPath = "file://" + UnityEngine.Application.dataPath + documentationPath + "#index";
        UnityEngine.Application.OpenURL(browserPath);
    ...
    static void openForum() {
        UnityEngine.Application.OpenURL("http://forum.unity3d.com/threads/leantween-a-tweening-engine-that-is-up-to-5x-faster-than-competing-engines.161113/");
    }

    [MenuItem("Help/LeanTween GitHub (contribute code)")]
    static void openGit() {
        UnityEngine.Application.OpenURL("https://github.com/dentedpixel/LeanTween");
    }

    [MenuItem("Help/LeanTween Support (donate)")]
    static void openLTDonate() {
        UnityEngine.Application.OpenURL("https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=YJPUT3RAK5VL8");
    }

    [MenuItem("Help/Dented Pixel News")]
    static void openDPNews() {
        UnityEngine.Application.OpenURL("http://dentedpixel.com/category/developer-diary/");
    }
}
